...
def doc_processing(uploaded_pdf,var1):
    ...
    return {state_var:[context_list,index]}
...
with gr.Blocks() as demo:
    ...
    upload_button.upload(doc_processing,[upload_button,state_var],state_var,queue=False,show_progress=True,trigger_mode="once")
